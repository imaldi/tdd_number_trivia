...
// in tdd_number_trivia/test/features/number_trivia/data/datasources/number_trivia_remote_data_source_test.dart.
...
class MockClient extends _i1.Mock implements _i2.Client {
  ...
  _i3.Future<_i2.Response> post(Uri? url,
      ...
      (super.noSuchMethod(Invocation.method(#post, [url], {#headers: headers, #body: body, #encoding: encoding}),
          ...
          returnValueForMissingStub: _i3.Future<_i2.Response>.value(
              _FakeResponse_0(this, Invocation.method(#post, [url], {#headers: headers, #body: body, #encoding: encoding})))) as _i3.Future<_i2.Response>);
  @override
      ...
      (super.noSuchMethod(Invocation.method(#patch, [url], {#headers: headers, #body: body, #encoding: encoding}),
          returnValue: _i3.Future<_i2.Response>.value(_FakeResponse_0(
              ...
              Invocation.method(#patch, [url],
                  {#headers: headers, #body: body, #encoding: encoding}))),
          returnValueForMissingStub: _i3.Future<_i2.Response>.value(
              _FakeResponse_0(this, Invocation.method(#patch, [url], {#headers: headers, #body: body, #encoding: encoding})))) as _i3.Future<_i2.Response>);
  @override
      ...
      (super.noSuchMethod(Invocation.method(#delete, [url], {#headers: headers, #body: body, #encoding: encoding}),
          returnValue: _i3.Future<_i2.Response>.value(_FakeResponse_0(
              ...
              Invocation.method(#delete, [url],
                  {#headers: headers, #body: body, #encoding: encoding}))),
          returnValueForMissingStub: _i3.Future<_i2.Response>.value(
              _FakeResponse_0(this, Invocation.method(#delete, [url], {#headers: headers, #body: body, #encoding: encoding})))) as _i3.Future<_i2.Response>);
  @override
